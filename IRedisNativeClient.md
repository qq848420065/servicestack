## NOTE: This page has moved to [IRedisNativeClient on GitHub](https://github.com/ServiceStack/ServiceStack.Redis/wiki/IRedisNativeClient). Please update your links. ##
...
This is a low-level API implemented by the [ServiceStack.Redis](ServiceStackRedis.md) client that provides raw byte access to a Redis server.
